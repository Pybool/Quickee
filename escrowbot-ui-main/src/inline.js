...
!(function () {
    var eventMethod = window.addEventListener ? "addEventListener" : "attachEvent",
        ...
        config = { siteUrl: "https://paystack.com/", paystackApiUrl: "https://api.paystack.co/", newCheckoutUrl: "https://checkout.paystack.com/" };
    function Inline(t) {
        (this.iframe = null),
    ...
    (Inline.prototype.setTransaction = function (t) {
        ...
        (Inline.prototype.createButton = function () {
            ...
            e.defaults.customButton
                ? (t = document.getElementById(e.defaults.customButton)).setAttribute("data-paystack", e.defaults.id)
                : (((t = document.createElement("button")).innerHTML = "<span class='paystack-top-blue'>Pay Securely with Paystack</span><span class='paystack-body-image'> </span>"),
        ...
        (Inline.prototype.setupOldPopup = function () {
            ...
            (e +=
                ...
                this.appendIframe({ src: this.getOldCheckoutURL(), cssText: e, className: "paystack_pop", parent: document.body }),
                (this.isSetup = !0);
        }),
        (Inline.prototype.getTransactionParameters = function () {
            ...
            return (
                ...
                t.split && "string" != typeof t.split && 0 < Object.keys(t.split).length && (t.split = JSON.stringify(t.split)),
                void 0 !== t.card && -1 < ["false", !1].indexOf(t.card) && ((t.channels = ["bank"]), delete t.card),
                void 0 !== t.bank && -1 < ["false", !1].indexOf(t.bank) && ((t.channels = ["card"]), delete t.bank),
                t
            );
        }),
        ...
        (Inline.prototype.openNewCheckout = function () {
            !this.iframe ||
                this.isIframeOpen ||
                this.isEmbed ||
                ((this.background.style.display = ""), (this.background.style.visibility = "visible"), (this.iframe.style.display = ""), this.iframe.contentWindow.postMessage("render", "*"), (this.isIframeOpen = !0));
        }),
        ...
        (Inline.prototype.handleSuccess = function (t) {
            ...
            if (this.defaults.callback || this.form)
                return this.form
                    ...
                    : void (this.defaults.callback && this.defaults.callback.call(this, t));
        }),
    ...
    var sourceScript = document.currentScript || ((ia = document.getElementsByTagName("script")), ia[ia.length - 1]),
        ia;
    ...
    function validateInputTypes(t) {
        var n = { email: "email", amount: "integer", transaction_charge: "integer", invoice_limit: "integer", onClose: "function", callback: "function", metadata: "object", channels: "array" };
        for (var e in t) {
            r(e, t[e]);
        }
        function r(t, e) {
    ...
    function parseResponse(t, e) {
        var n, r, i, a, o;
        return "string" == typeof t && (n = t.split(" ")[0]), n && ((i = (r = t.split(" "))[1]), (a = r.slice(2).join(" ")), (o = e.id == i)), { action: n, isThisIframe: o, data: a };
    }
    ...
    function cssLoad(t, e) {
        ...
        return (
            ...
            void 0 !== u.addEventListener
                ? (u.addEventListener("load", d, !1), u.addEventListener("error", l, !1))
                : void 0 !== u.attachEvent &&
                  u.attachEvent("onload", function () {
                      var t,
    ...
    (function (t) {
        ...
        function w(t, e) {
            ...
            if (
                ...
                (this.method = ((r = (n = e.method || this.method || "GET").toUpperCase()), -1 < d.indexOf(r) ? r : n)),
